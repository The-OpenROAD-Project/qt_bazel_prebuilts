...
template <> constexpr inline auto QNativeSocketEngine::qt_create_metaobjectdata<qt_meta_tag_ZN19QNativeSocketEngineE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QNativeSocketEngine, qt_meta_tag_ZN19QNativeSocketEngineE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject QNativeSocketEngine::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QNativeSocketEngineE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QNativeSocketEngineE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19QNativeSocketEngineE_t>.metaTypes,
    nullptr
} };
...
void *QNativeSocketEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QNativeSocketEngineE_t>.strings))
