...
template <> constexpr inline auto QErrorMessage::qt_create_metaobjectdata<qt_meta_tag_ZN13QErrorMessageE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QErrorMessage, qt_meta_tag_ZN13QErrorMessageE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QErrorMessage::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QErrorMessageE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QErrorMessageE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13QErrorMessageE_t>.metaTypes,
    nullptr
} };
...
void *QErrorMessage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QErrorMessageE_t>.strings))
