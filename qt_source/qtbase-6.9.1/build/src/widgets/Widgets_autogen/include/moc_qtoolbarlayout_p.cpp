...
template <> constexpr inline auto QToolBarLayout::qt_create_metaobjectdata<qt_meta_tag_ZN14QToolBarLayoutE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QToolBarLayout, qt_meta_tag_ZN14QToolBarLayoutE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QToolBarLayout::staticMetaObject = { {
    QMetaObject::SuperData::link<QLayout::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14QToolBarLayoutE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14QToolBarLayoutE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14QToolBarLayoutE_t>.metaTypes,
    nullptr
} };
...
void *QToolBarLayout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14QToolBarLayoutE_t>.strings))
