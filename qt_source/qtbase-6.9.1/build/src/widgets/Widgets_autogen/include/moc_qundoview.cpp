...
template <> constexpr inline auto QUndoView::qt_create_metaobjectdata<qt_meta_tag_ZN9QUndoViewE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'setStack'
        QtMocHelpers::SlotData<void(QUndoStack *)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'setGroup'
        QtMocHelpers::SlotData<void(QUndoGroup *)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
    };
    QtMocHelpers::UintData qt_properties {
        ...
        // property 'cleanIcon'
        QtMocHelpers::PropertyData<QIcon>(9, QMetaType::QIcon, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet),
    };
    QtMocHelpers::UintData qt_enums {
    };
    return QtMocHelpers::metaObjectData<QUndoView, qt_meta_tag_ZN9QUndoViewE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QUndoView::staticMetaObject = { {
    QMetaObject::SuperData::link<QListView::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9QUndoViewE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9QUndoViewE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9QUndoViewE_t>.metaTypes,
    nullptr
} };
...
void *QUndoView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9QUndoViewE_t>.strings))
