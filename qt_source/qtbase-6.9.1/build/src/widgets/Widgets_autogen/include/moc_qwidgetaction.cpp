...
template <> constexpr inline auto QWidgetAction::qt_create_metaobjectdata<qt_meta_tag_ZN13QWidgetActionE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QWidgetAction, qt_meta_tag_ZN13QWidgetActionE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QWidgetAction::staticMetaObject = { {
    QMetaObject::SuperData::link<QAction::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QWidgetActionE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QWidgetActionE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13QWidgetActionE_t>.metaTypes,
    nullptr
} };
...
void *QWidgetAction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QWidgetActionE_t>.strings))
