...
template <> constexpr inline auto QStatusBar::qt_create_metaobjectdata<qt_meta_tag_ZN10QStatusBarE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QStatusBar, qt_meta_tag_ZN10QStatusBarE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QStatusBar::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10QStatusBarE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10QStatusBarE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10QStatusBarE_t>.metaTypes,
    nullptr
} };
...
void QStatusBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (QStatusBar::*)(const QString & )>(_a, &QStatusBar::messageChanged, 0))
            return;
    }
...
void *QStatusBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10QStatusBarE_t>.strings))
