...
template <> constexpr inline auto QSizeGrip::qt_create_metaobjectdata<qt_meta_tag_ZN9QSizeGripE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QSizeGrip, qt_meta_tag_ZN9QSizeGripE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QSizeGrip::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9QSizeGripE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9QSizeGripE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9QSizeGripE_t>.metaTypes,
    nullptr
} };
...
void *QSizeGrip::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9QSizeGripE_t>.strings))
