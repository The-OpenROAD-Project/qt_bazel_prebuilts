...
template <> constexpr inline auto QWidgetWindow::qt_create_metaobjectdata<qt_meta_tag_ZN13QWidgetWindowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QWidgetWindow, qt_meta_tag_ZN13QWidgetWindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QWidgetWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QWidgetWindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QWidgetWindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13QWidgetWindowE_t>.metaTypes,
    nullptr
} };
...
void *QWidgetWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QWidgetWindowE_t>.strings))
