...
template <> constexpr inline auto QItemDelegate::qt_create_metaobjectdata<qt_meta_tag_ZN13QItemDelegateE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QItemDelegate, qt_meta_tag_ZN13QItemDelegateE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject QItemDelegate::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QItemDelegateE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QItemDelegateE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13QItemDelegateE_t>.metaTypes,
    nullptr
} };
...
void *QItemDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QItemDelegateE_t>.strings))
