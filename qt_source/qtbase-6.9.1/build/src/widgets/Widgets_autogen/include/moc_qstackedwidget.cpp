...
template <> constexpr inline auto QStackedWidget::qt_create_metaobjectdata<qt_meta_tag_ZN14QStackedWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QStackedWidget, qt_meta_tag_ZN14QStackedWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QStackedWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QFrame::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14QStackedWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14QStackedWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14QStackedWidgetE_t>.metaTypes,
    nullptr
} };
...
void QStackedWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (QStackedWidget::*)(int )>(_a, &QStackedWidget::currentChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (QStackedWidget::*)(int )>(_a, &QStackedWidget::widgetRemoved, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (QStackedWidget::*)(int )>(_a, &QStackedWidget::widgetAdded, 2))
            return;
    }
...
void *QStackedWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14QStackedWidgetE_t>.strings))
...
// SIGNAL 2
void QStackedWidget::widgetAdded(int _t1)
{
