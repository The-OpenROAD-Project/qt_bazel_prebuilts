...
template <> constexpr inline auto QSplashScreen::qt_create_metaobjectdata<qt_meta_tag_ZN13QSplashScreenE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'showMessage'
        QtMocHelpers::SlotData<void(const QString &, int, const QColor &)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 3 }, { QMetaType::Int, 5 }, { QMetaType::QColor, 6 },
        }}),
        // Slot 'showMessage'
        QtMocHelpers::SlotData<void(const QString &, int)>(4, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
    ...
    return QtMocHelpers::metaObjectData<QSplashScreen, qt_meta_tag_ZN13QSplashScreenE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QSplashScreen::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QSplashScreenE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QSplashScreenE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13QSplashScreenE_t>.metaTypes,
    nullptr
} };
...
void QSplashScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (QSplashScreen::*)(const QString & )>(_a, &QSplashScreen::messageChanged, 0))
            return;
    }
}
...
void *QSplashScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QSplashScreenE_t>.strings))
