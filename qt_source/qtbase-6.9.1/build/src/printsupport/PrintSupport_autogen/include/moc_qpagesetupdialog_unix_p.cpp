...
namespace {
struct qt_meta_tag_ZN16QPageSetupWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto QPageSetupWidget::qt_create_metaobjectdata<qt_meta_tag_ZN16QPageSetupWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QPageSetupWidget, qt_meta_tag_ZN16QPageSetupWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QPageSetupWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16QPageSetupWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16QPageSetupWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN16QPageSetupWidgetE_t>.metaTypes,
    nullptr
} };
...
void *QPageSetupWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16QPageSetupWidgetE_t>.strings))
